...
set -l commands list install remove show man update list-opcodes
...
complete -f -c risset -n "not __fish_seen_subcommand_from $commands" -a list-opcodes -d 'List installed opcodes'


complete -f -c risset -n "__fish_seen_subcommand_from man" -a "(risset list-opcodes)"
